...
from custom_components.xiaomi_cloud_map_extractor.common.valetudo_local_connector import ValetudoLocalConnector
...
PLATFORM_SCHEMA = PLATFORM_SCHEMA.extend(
    {
        vol.Required(CONF_VALETUDO): cv.boolean,
...
async def async_setup_platform(hass, config, async_add_entities, discovery_info=None):
    ...
    use_valetudo = config[CONF_VALETUDO]
    ...
    async_add_entities([VacuumCamera(entity_id, use_valetudo, host, token, username, password, country, name, should_poll,
...
class VacuumCamera(Camera):
    def __init__(self, entity_id: str, use_valetudo: bool, host: str, token: str, username: str, password: str, country: str, name: str,
        ...
        if use_valetudo:
            self._connector = ValetudoLocalConnector(username, password)
        else:
