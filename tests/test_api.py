"""Tests for Xiaomi-Cloud-Map-Extractor api."""
import asyncio

import aiohttp
from custom_components.xiaomi_cloud_map_extractor.api import (
    XiaomiCloudMapExtractorApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = XiaomiCloudMapExtractorApiClient("test", "test", async_get_clientsession(hass))
